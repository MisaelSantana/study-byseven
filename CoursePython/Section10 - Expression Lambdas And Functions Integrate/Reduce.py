...
99% das vezes em um loop for é mais legível.
...
-> passo 1: res2 = f(res1, a3) # Aplica a função passando o resultado de passo1 mais o terceiro elemento e guarda o res.
...
# Ou seja, em cada passo ele aplica a função passando como primeiro argumento o resultado da aplicaçãoanterior.
