...
# Em linguagens de programação como o Java, ao declararmos atributos privados
  ...
  atributos. Esses métodos são conhecidos por getters e setters, onde os getters 
  retornam o valor do atributo e os setters alteram o valor do mesmo.

# Por convenção, utilizar a seguinte nomemclatura:
-> Para Getters:
    -> get_<atributo>
...
conta1 = Conta('Misael', 3000, 5000)
conta2 = Conta('Thaynara', 3000, 5000)
